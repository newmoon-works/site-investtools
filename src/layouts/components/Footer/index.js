          ...
          <div className="row justify-content-between">
            ...
            <div className={`col-12 col-lg-3 ${styles.footerBox}`}>
              <div>
                ...
                <div>
                  <p className="caption">A Investtools está sempre em busca de soluções <br /> importantes e inéditas para o mercado financeiro.</p>
                  <div className={styles.socials}>
                    <a href="https://www.linkedin.com/company/investtools/" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://www.instagram.com/investtools_/" target="_blank" rel="noopener noreferrer">
